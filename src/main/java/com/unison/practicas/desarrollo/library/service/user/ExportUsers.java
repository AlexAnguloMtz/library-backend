...
public class ExportUsers {
    ...
    public ExportUsers(UserRepository userRepository, TemplateEngine templateEngine) {
    ...
    public ExportResponse handle(User currentUser, ExportRequest request) {
    ...
    private byte[] generatePdf(User currentUser, List<User> users) {
