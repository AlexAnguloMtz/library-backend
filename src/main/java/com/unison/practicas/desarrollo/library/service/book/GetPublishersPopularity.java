...
import com.unison.practicas.desarrollo.library.dto.book.response.PublisherPopularityResponse;
...
import static com.unison.practicas.desarrollo.library.jooq.tables.Publisher.PUBLISHER;
...
@Component
public class GetPublishersPopularity {

    private final DSLContext dsl;

    public GetPublishersPopularity(DSLContext dsl) {
        this.dsl = dsl;
    }

    public List<PublisherPopularityResponse> get(PopularityRequest request) {
        ...
        var loansPerUser = dsl.select(
                ...
                .groupBy(PUBLISHER.ID, PUBLISHER.NAME, GENDER.NAME, APP_USER.DATE_OF_BIRTH, BOOK_LOAN.USER_ID)
                .asTable("loans_per_user");

        var valueField = aggregateFieldForMetric(metric, loansPerUser);

        var aggPerGroup = dsl.select(
                        loansPerUser.field("publisher_id", Integer.class),
                        loansPerUser.field("publisher_name", String.class),
        ...
        var allCombinations = dsl.select(
                        allPublishers.field("publisher_id", Integer.class),
                        allPublishers.field("publisher_name", String.class),
        ...
        var filledAgg = dsl.select(
                        allCombinations.field("publisher_id", Integer.class),
                        allCombinations.field("publisher_name", String.class),
                ...
                .on(allCombinations.field("publisher_id", Integer.class).eq(aggPerGroup.field("publisher_id", Integer.class)))
                .and(allCombinations.field("publisher_name", String.class).eq(aggPerGroup.field("publisher_name", String.class)))
        ...
        var rankedTop = dsl.select(
                        filledAgg.field("publisher_id", Integer.class),
                        filledAgg.field("publisher_name", String.class),
        ...
        var query = dsl.select(
                        rankedTop.field("publisher_id", String.class),
                        rankedTop.field("publisher_name", String.class),
        ...
        return query.fetch()
                .map(record -> {
                    ...
                    return PublisherPopularityResponse.builder()
                            .publisherId(record.get("publisher_id", Integer.class).toString())
                            .publisherName(record.get("publisher_name", String.class))
